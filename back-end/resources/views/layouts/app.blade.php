                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost:5174/">
                                <img src="{{asset('logo.png')}}" alt="Deliveboo" height="50px">
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav gap-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item animated-span ps-1" href="#">{{__('Dashboard')}}</a>
                                <!--                                 <a class="dropdown-item" href="{{ url('profile') }}">{{__('Profile')}}</a> -->
                                <a class="dropdown-item animated-span ps-1" href="{{ route('logout') }}" onclick="event.preventDefault();
